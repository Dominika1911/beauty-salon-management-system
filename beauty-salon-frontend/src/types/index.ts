...
export interface StatisticsDelta<TDelta> {
  delta: TDelta;
  delta_pct: number | null;
}

export type StatisticsDeltaNumber = StatisticsDelta<number>;
export type StatisticsDeltaMoney = StatisticsDelta<string>;

export interface StatisticsComparison {
  total_revenue?: StatisticsDeltaMoney;
  new_clients?: StatisticsDeltaNumber;
  appointments?: {
    total?: StatisticsDeltaNumber;
    completed?: StatisticsDeltaNumber;
    cancelled?: StatisticsDeltaNumber;
    no_show?: StatisticsDeltaNumber;
  };
  [key: string]: unknown;
}
