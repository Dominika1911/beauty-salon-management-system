...
export default function EmployeesPage(): JSX.Element {
        ...
        try {
            ...
            if (!isEdit) {
                ...
                if (form.password.trim().length < 8) {
                    ...
                    setFormError(
                        'Nie udało się zapisać — popraw zaznaczone pola i spróbuj ponownie.',
                    );
                    return;
                }
            }
    ...
    return (
        <Stack spacing={2}>
            ...
            >
                <Box sx={{ minWidth: 240 }}>
                    ...
                    <Typography variant="body2" sx={{ color: 'text.secondary' }}>
                        Łącznie: {employeesData?.count ?? '—'} • Strona: {page} • Sortowanie:{' '}
                        {orderingLabel}
                    </Typography>
                </Box>
            ...
            {pageError && (
                <Alert
                    severity={publicDataWarning ? 'warning' : 'error'}
                    ...
                    >
                        ...
                        <FormControl sx={{ minWidth: 220 }} disabled={busy}>
                            ...
                            <Select
                                ...
                                label="Status"
                                onChange={(e) =>
                                    setDraftIsActiveFilter(e.target.value as IsActiveFilter)
                                }
                            >
                ...
                <DialogContent dividers>
                    <Stack spacing={2}>
                        ...
                        <FormControl
                            fullWidth
                            disabled={busy}
                            error={Boolean(formFieldErrors.skill_ids)}
                        >
                            ...
                            <Select
                                ...
                                onChange={(e) =>
                                    setForm((p) => ({
                                        ...p,
                                        skill_ids: e.target.value as number[],
                                    }))
                                }
            ...
            <Dialog
                ...
                onClose={resetLoading ? undefined : closeResetDialog}
                fullWidth
                maxWidth="sm"
            >
            ...
            >
                ...
                <DialogContent dividers>
                    ...
                    <Typography variant="caption" color="text.secondary">
                        Tej operacji nie można cofnąć. Jeśli są powiązane wizyty, usunięcie może być
                        zablokowane.
                    </Typography>
                </DialogContent>
                <DialogActions>
