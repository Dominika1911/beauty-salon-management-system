                  ...
                  {loadingEmployees ? (
                    ...
                    employees.map((e) => (
                      <MenuItem key={e.id} value={String(e.id)}>
                        ...
                        {"employee_number" in e && e.employee_number ? ` (${e.employee_number})` : ""}
                      </MenuItem>
                    ))
                  )}
                </Select>
                  ...
                  <Paper key={x.id} variant="outlined" sx={{ p: 1.75 }}>
                    <Stack direction={{ xs: "column", md: "row" }} spacing={1.5} alignItems={{ md: "center" }}>
                      <Box sx={{ minWidth: 260 }}>
                        ...
                        <Typography variant="body2" sx={{ mt: 0.5 }} color={x.reason ? "text.primary" : "text.secondary"}>
                      ...
                      <Box sx={{ display: "flex", justifyContent: { xs: "flex-start", md: "flex-end" }, width: "100%" }}>
                        <ButtonGroup
                          ...
                          size="small"
                          disabled={busy}
                          sx={{ flexWrap: "wrap", "& .MuiButton-root": { whiteSpace: "nowrap" } }}
                        >
                          <Button
                            variant="contained"
                            color="success"
                            disabled={busy || !x.can_approve}
                            onClick={() => void runAction(timeOffApi.approve, x.id, "Wniosek zaakceptowany.")}
                          >
                            Akceptuj
                          </Button>
                          <Button
                            ...
                            onClick={() => void runAction(timeOffApi.reject, x.id, "Wniosek odrzucony.")}
                          >
                            Odrzuć
                          </Button>
                        </ButtonGroup>
