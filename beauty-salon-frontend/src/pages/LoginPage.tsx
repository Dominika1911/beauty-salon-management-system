...
const LoginPage: React.FC = () => {
  ...
  const canSubmit = useMemo(() => username.trim().length > 0 && password.length > 0 && !loading, [
    username,
    password,
    loading,
  ]);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setFormError(parsed.message || "Nie udało się zalogować. Sprawdź dane i spróbuj ponownie.");
              ...
              <Box component="form" onSubmit={handleSubmit} noValidate>
                <Stack spacing={2}>
                  ...
                  <Typography variant="body2" color="text.secondary" sx={{ textAlign: "center" }}>
                    Jeśli masz problem z logowaniem, skontaktuj się z administratorem.
                  </Typography>
                </Stack>
              </Box>
            </Stack>
