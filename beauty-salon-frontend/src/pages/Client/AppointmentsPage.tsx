...
export default function ClientAppointmentsPage(): JSX.Element {
  ...
  const [cancelDialog, setCancelDialog] = useState<CancelDialogState>({ open: false, appt: null });
    ...
    try {
      ...
      setData((prev) => {
        ...
        const removedByFilter =
          filterActive && nextResultsRaw.some((r) => r.id === updated.id) && updated.status !== statusFilter;
    ...
    <Stack spacing={2} sx={{ maxWidth: 980, mx: "auto", p: { xs: 1.5, sm: 2.5 } }}>
          ...
          <Stack direction={{ xs: "column", md: "row" }} spacing={2} alignItems={{ md: "center" }}>
            ...
            <Stack direction="row" spacing={1} justifyContent={{ xs: "stretch", md: "flex-end" }}>
              <Button
                ...
                disabled={busy || (!isDirty && statusFilter === "ALL" && ordering === "start")}
              >
                Wyczyść filtry
              </Button>
              ...
              <Stack spacing={1}>
                ...
                >
                  ...
                  <Stack alignItems={{ xs: "flex-start", sm: "flex-end" }} spacing={0.5}>
                    <Chip size="small" label={a.status_display || statusLabel(a.status)} color={statusChipColor(a.status)} />
      ...
      <Dialog open={cancelDialog.open} onClose={closeCancel} maxWidth="xs" fullWidth>
        ...
        <DialogContent>
          ...
          {cancelDialog.appt ? (
            <Box sx={{ mt: 2 }}>
              <Typography fontWeight={800}>{cancelDialog.appt.service_name}</Typography>
              <Typography variant="body2" color="text.secondary">
        ...
        <DialogActions sx={{ px: 3, pb: 2 }}>
          ...
          <Button
            ...
            startIcon={busyCancelId != null ? <CircularProgress size={18} /> : undefined}
          >
            Anuluj
          </Button>
        </DialogActions>
