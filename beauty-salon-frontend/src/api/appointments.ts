...
import type { Appointment, AppointmentStatus, BookingCreate, DRFPaginated } from '@/types';
...
export const appointmentsApi = {
    ...
    list: async (params?: AppointmentListParams): Promise<DRFPaginated<Appointment>> => {
        const response = await axiosInstance.get<DRFPaginated<Appointment>>('/appointments/', {
            params,
        });
    ...
    getMy: async (params?: {
        ...
        const response = await axiosInstance.get<DRFPaginated<Appointment>>('/appointments/my/', {
            params,
        });
        return response.data;
    },
     ...
     */
    update: async (id: number, data: AppointmentUpdatePayload): Promise<Appointment> => {
        ...
        const response = await axiosInstance.patch<Appointment>(`/appointments/${id}/`, payload);
        return response.data;
    },
    ...
    noShow: async (id: number): Promise<Appointment> => {
        const response = await axiosInstance.post<Appointment>(`/appointments/${id}/no-show/`);
        return response.data;
    },
