    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='klient', to=settings.AUTH_USER_MODEL, verbose_name='użytkownik')),
            ],
            options={
                'verbose_name': 'klient',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, db_index=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('nr', models.CharField(db_index=True, default=beauty_salon.models.generate_employee_number, max_length=20, unique=True, validators=[django.core.validators.RegexValidator('^EMP-\\d{4}$', 'Format numeru: EMP-0001')], verbose_name='numer pracownika')),
                ('imie', models.CharField(max_length=100, verbose_name='imię')),
                ('nazwisko', models.CharField(max_length=100, verbose_name='nazwisko')),
                ('telefon', models.CharField(blank=True, max_length=20, verbose_name='telefon')),
                ...
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='pracownik', to=settings.AUTH_USER_MODEL, verbose_name='użytkownik')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('aktywny', models.BooleanField(db_index=True, default=True, verbose_name='aktywny')),
                ('wlasciciel_prac', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='materialy', to='beauty_salon.pracownik', verbose_name='właściciel pracownik')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['kategoria', 'nazwa'], name='uslugi_kategor_2a1dd5_idx'), models.Index(fields=['publikowana'], name='uslugi_publiko_cacf1e_idx'), models.Index(fields=['promocja'], name='uslugi_promocj_f52657_idx'), models.Index(fields=['liczba_rezerwacji'], name='uslugi_liczba__38ba9d_idx')],
                'constraints': [models.UniqueConstraint(fields=('kategoria', 'nazwa'), name='uniq_usluga_kategoria_nazwa')],
            },
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timespan', django.contrib.postgres.fields.ranges.DateTimeRangeField(verbose_name='zakres czasu')),
        ...
        migrations.AddConstraint(
            model_name='wizyta',
            constraint=models.CheckConstraint(condition=models.Q(('termin_koniec__gt', models.F('termin_start'))), name='wizyty_end_after_start'),
        ),
        migrations.AddConstraint(
            model_name='wizyta',
