    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Zaktualizowano')),
                ('deleted_at', models.DateTimeField(blank=True, null=True, verbose_name='usunięte (GDPR)')),
                ('number', models.CharField(blank=True, default=beauty_salon.utils.generate_client_number, max_length=20, null=True, unique=True, verbose_name='numer klienta')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Zaktualizowano')),
                ('deleted_at', models.DateTimeField(blank=True, null=True, verbose_name='usunięte (GDPR)')),
                ('number', models.CharField(blank=True, default=beauty_salon.utils.generate_employee_number, max_length=20, null=True, unique=True, verbose_name='numer pracownika')),
                ('first_name', models.CharField(blank=True, max_length=150, verbose_name='imię')),
                ('last_name', models.CharField(blank=True, max_length=150, verbose_name='nazwisko')),
